document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadMission() {
        ...
        try {
            ...
            if (resp.ok) {
                const data = await resp.ok ? await resp.json() : BAKED_DATA;
