document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateDaySelection(daySelected) {
        console.log('Switching to Day:', daySelected);
        ...
        const summaryOutline = document.querySelector('#protocol-timeline .summary-outline');
        ...
        if (daySelected === 'all') {
            ...
            dayOutlines.forEach(outline => {
                ...
                outline.style.display = (oDay === daySelected) ? 'block' : 'none';
            });
        }
    ...
    const SAVE_KEY = 'exodigo_field_ops_v56';
