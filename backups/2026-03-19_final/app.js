document.addEventListener('DOMContentLoaded', () => {
    ...
    const DEFAULT_LAYOUT = [
        ...
        { lat: 40.2478, lng: -77.17150, angle: 0, color: '#ffff00', name: '1. נק׳ מפתח (תשתית מרכזית)', type: 'circle' },
        { lat: 40.2470, lng: -77.17050, angle: 0, color: '#ffff00', name: '2. נק׳ מפתח (שינויי גבהים)', type: 'circle' },
        { lat: 40.2460, lng: -77.16950, angle: 0, color: '#ffff00', name: '3. נק׳ מפתח', type: 'circle' },
        { lat: 40.2450, lng: -77.17100, angle: 0, color: '#ffff00', name: '4. נק׳ מפתח', type: 'circle' },
        { lat: 40.2440, lng: -77.17250, angle: 0, color: '#ffff00', name: '5. נק׳ מפתח', type: 'circle' },
        { lat: 40.2430, lng: -77.17400, angle: 0, color: '#ffff00', name: '6. נק׳ מפתח', type: 'circle' },
        { lat: 40.2420, lng: -77.17550, angle: 0, color: '#ffff00', name: '7. נק׳ מפתח (ריכוז תשתיות מים)', type: 'circle' },
        { lat: 40.2494, lng: -77.17050, angle: 0, color: '#ffff00', name: 'נקי מפתח', type: 'circle' }
    ];
